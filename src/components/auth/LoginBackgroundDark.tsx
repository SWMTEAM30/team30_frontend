    ...
    <div className="hidden dark:block fixed inset-0 w-screen h-screen z-0">
      ...
      >
        ...
        <g opacity="0.2" filter="url(#glow)">
          <path d="M 1400 150 L 1450 100 L 1500 150 Z" fill="#6a9bd8" opacity="0.5">
            <animateTransform
          ...
          <circle cx="1200" cy="300" r="60" fill="none" stroke="#6a9bd8" strokeWidth="2" opacity="0.5">
        ...
        <g opacity="0.15">
          <rect x="400" y="-200" width="200" height="1400" fill="url(#accentGradient)" transform="rotate(15 500 500)">
          ...
          >
            <animate attributeName="opacity" values="0.15;0.22;0.15" dur="7s" repeatCount="indefinite" />
          </rect>
        </g>

        <rect width="1920" height="1080" fill="url(#glowGradient)" opacity="0.1" />
      </svg>
